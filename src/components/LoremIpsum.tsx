export function LoremIpsum() {
    return (
        <article className="mx-auto p-3 max-w-[500px]">
          <p className="mb-3">
          ...
          <h2 className="font-bold mt-5 mb-1">Sub-header</h2>
          <p className="mb-3">
          ...
          <p className="mb-3">Quisque convallis ligula non magna efficitur tincidunt.</p>
          <p className="mb-3">
            Pellentesque id lacus pulvinar elit pulvinar pretium ac non urna.
            Mauris id mauris vel arcu commodo venenatis. Aliquam eu risus arcu.
            Proin sit amet lacus mollis, semper massa ut, rutrum mi.
          </p>
          <p className="mb-3">Sed sem nisi, luctus consequat ligula in, congue sodales nisl.</p>
          <p className="mb-3">
            Vestibulum bibendum at erat sit amet pulvinar. Pellentesque pharetra
            leo vitae tristique rutrum. Donec ut volutpat ante, ut suscipit leo.
          </p>
